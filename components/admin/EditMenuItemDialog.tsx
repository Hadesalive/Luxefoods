...
export function EditMenuItemDialog({ item, open, onOpenChange }: EditMenuItemDialogProps) {
  ...
  useEffect(() => {
    if (item) {
      const isMultiplePrice = typeof item.price === "object"
      setFormData({
        name: item.name,
        ...
        pricingType: isMultiplePrice ? "multiple" : "single",
        singlePrice: isMultiplePrice ? "" : item.price.toString(),
        smallPrice: isMultiplePrice && typeof item.price === "object" ? item.price.S?.toString() || "" : "",
        mediumPrice: isMultiplePrice && typeof item.price === "object" ? item.price.M?.toString() || "" : "",
        largePrice: isMultiplePrice && typeof item.price === "object" ? item.price.L?.toString() || "" : "",
      })
    }
  }, [item])
            ...
            <Select
              ...
              onValueChange={(value) => {
                setFormData({
                  ...formData,
                  category: value,
                  pricingType: value === "pizza" ? "multiple" : formData.pricingType,
                })
              }}
            >
              <SelectTrigger>
