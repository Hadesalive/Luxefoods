...
export default function PrivacyPage() {
  ...
  const handleAccessCodeSubmit = (e: React.FormEvent) => {
    ...
    if (accessCode === "kings_privacy_2024" || accessCode === "alpha_dev_2024") {
      setIsAuthenticated(true)
      setError("")
    } else {
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-orange-200 dark:border-orange-800 p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                This page contains sensitive privacy information and requires authentication.
              </p>
            </div>

            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 mb-6">
              <p className="text-red-800 dark:text-red-200 text-sm">
                ⚠️ <strong>Access Restricted:</strong> This privacy policy is protected and requires proper authorization to view.
              </p>
            </div>
