...
export default function CheckoutPage() {
  ...
  if (orderStatus.step === "success") {
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 flex items-center justify-center transition-colors duration-300">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-950/50 p-4 rounded-lg border border-gray-200 dark:border-gray-800">
                  ...
                  <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-2 text-left">
                    <li className="flex items-center gap-2">
                      <span className="w-2 h-2 bg-black dark:bg-white rounded-full"></span>📱 Click the
                      WhatsApp button to send your order
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="w-2 h-2 bg-black dark:bg-white rounded-full"></span>✅ Restaurant
                      confirms your order within 5 minutes
                    </li>
                    <li className="flex items-center gap-2">
                    ...
                    <li className="flex items-center gap-2">
                      ...
                      {deliveryMethod === "delivery"
                        ...
                        : "🏪 Ready for pickup: 15-30 minutes"}
                    </li>
                  </ul>
                </div>

                <div className="bg-blue-50 dark:bg-blue-950/50 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                  <h3 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">📞 Contact Information</h3>
                  <div className="text-sm text-blue-700 dark:text-blue-300">
                                    <p>📱 Phone: 076 533655</p>
                <p>💬 WhatsApp: 076 533655</p>
                    <p>📧 Email: info@thekingsbakerysl.com</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  <Link href="/#menu" className="flex-1">
                    <Button
                      variant="outline"
                      className="w-full border-black dark:border-gray-700 text-black dark:text-white hover:bg-gray-50 dark:hover:bg-gray-950/50 rounded-2xl"
                    >
                      Order More
                    </Button>
                  </Link>
                  <Link href="/" className="flex-1">
                    <Button className="w-full bg-black hover:bg-gray-800 dark:bg-gray-800 dark:hover:bg-gray-700 text-white rounded-2xl">
                      Back to Home
                    </Button>
                  </Link>
                </div>
  ...
  if (orderStatus.step === "error") {
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-50 dark:from-red-950/20 dark:to-pink-950/20 flex items-center justify-center transition-colors duration-300">
          ...
          <Card className="shadow-xl border-red-200 dark:border-red-800 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
            <CardContent className="p-8">
              <div className="mb-6">
                ...
                <h1 className="text-2xl lg:text-3xl font-bold mb-4 text-red-800 dark:text-red-200">Order Failed</h1>
                <p className="text-red-700 dark:text-red-300 mb-6">{orderStatus.message}</p>
              </div>

              <div className="space-y-4">
                <Button
                  onClick={() => {
                    setOrderStatus({ step: "form" })
                    setIsProcessing(false)
                  }}
                  className="w-full bg-red-600 hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-600 text-white rounded-2xl"
                >
                  Try Again
                </Button>

                <div className="bg-red-50 dark:bg-red-950/50 p-4 rounded-lg border border-red-200 dark:border-red-800">
                  <h3 className="font-semibold text-red-800 dark:text-red-200 mb-2">Alternative Options:</h3>
                  <div className="text-sm text-red-700 dark:text-red-300 space-y-2">
                    <p>
                      📞 Call us directly: <strong>077 254220 / 076 369828</strong>
                    </p>
                    <p>
                      💬 WhatsApp: <strong>076 533655</strong>
                    </p>
                    <p>📧 Email: info@thekingsbakerysl.com</p>
                  </div>
                </div>
